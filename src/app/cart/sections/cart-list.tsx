...
export default function CartList() {
  ...
  return (
    <section className="col-span-4 lg:w-[750px] font-poppins h-fit overflow-y-auto">
      <Table className="min-w-full">
        <TableHeader>
          <TableRow className="bg-[#FFF9E5] hover:bg-[#FFF9E5]">
          ...
          {cartItems.map((item) => (
            <TableRow key={item.id} className="hover:bg-transparent">
              ...
              <TableCell className="text-center">
                ...
                >
                  <BinIcon className="w-[22px] h-[22px] fill-[#FBEBB5] group-hover:fill-[#FBEBB5] transition-all duration-300" />
                </Button>
              </TableCell>
            </TableRow>
          ))}
