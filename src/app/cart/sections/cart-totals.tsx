...
export default function CartTotals() {
  ...
  return (
    <div className="col-span-4 px-5 sm:px-0 lg:w-[350px] flex flex-col items-center justify-between pt-5 pb-7 gap-5 lg:bg-lightOrange font-poppins rounded-[8px] h-fit bg-[#FFF9E5]">
      <div className="flex flex-col gap-5 items-start lg:items-center w-full lg:w-[90%]">
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between mt-2 pt-3 border-t border-myOrange">
            ...
            <p className="text-[#B88E2F]">Rs: {calculateTotal().toLocaleString()}</p>
          </div>
        </div>
      </div>
