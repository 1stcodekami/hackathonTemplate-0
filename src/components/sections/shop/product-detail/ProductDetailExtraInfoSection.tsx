  ...
  return (
    <section className="flex flex-col items-center justify-center">
      <div className="flex gap-[53px]">
        <p className="text-black text-normal md:text-[24px] font-semibold">
          Description
        </p>
        <p className="text-[#9F9F9F] text-normal md:text-[24px]">
      ...
      <div className="mt-[37px] ">
        <p className="text-[#9F9F9F] text-normal">
        ...
        <p className="text-[#9F9F9F] text-normal mt-[30px]">
